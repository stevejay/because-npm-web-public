  ...
  <React.Fragment>
    ...
    <LegalContent>
      ...
      <p>
        ...
        that Middle Engine Software Ltd shall not be responsible or liable,
      ...
      <p>
        Middle Engine Software Ltd its subsidiaries, affiliates, and its
      ...
      <p>
        ...
        other provision of these terms, under no circumstances will Middle
        Engine Software Ltd ever be liable to you or any other person for any
        indirect, incidental, consequential, special, punitive or exemplary loss
        or damage arising from, connected with, or relating to your use of the
        Service, these Terms, the subject matter of these Terms, the termination
        of these Terms or otherwise, including but not limited to personal
        injury, loss of data, business, markets, savings, income, profits, use,
        production, reputation or goodwill, anticipated or otherwise, or
        economic loss, under any theory of liability (whether in contract, tort,
        strict liability or any other theory or law or equity), regardless of
        any negligence or other fault or wrongdoing (including without
        limitation gross negligence and fundamental breach) by Middle Engine
        Software Ltd or any person for whom Middle Engine Software Ltd is
        responsible, and even if Middle Engine Software Ltd has been advised of
